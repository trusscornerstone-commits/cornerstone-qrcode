...
SECRET_KEY = 'django-insecure-1@e3ko@1^+v1r=7ix2rp6+7#eri)yc#m*+eawzap31_b3^%a9u'
...
DATABASES = {
    'default': dj_database_url.config(default='postgres://cornerstone:cornerstone@db:5432/cornerstone', conn_max_age=600)
}
